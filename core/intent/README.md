...
**Responsabilidad prevista:** Intent Engine: interpreta lenguaje natural y produce una Action estructurada (contracts/action.py).

**Cuando se implementa:** Fase 1 (v0.1).
