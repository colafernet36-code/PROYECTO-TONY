...
**Responsabilidad prevista:** Terminal/Tool Agent: intent -> ToolCall estructurada -> Risk Classifier -> Policy Engine -> ejecucion auditada (v0.3 S12).

**Cuando se implementa:** Paso 8 (v0.3): dry-run primero.
